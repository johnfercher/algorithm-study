...
func TestInsertionInt_WhenOrderAsc_ShouldOrderAsc(t *testing.T) {
	// Arrange
	...
	// Act
	sortedArr := sort.InsertionInt(unsortedArr, false)
...
func TestInsertionInt_WhenOrderDesc_ShouldOrderDesc(t *testing.T) {
	// Arrange
	unsortedArr := generate.UnsortedIntArray(10, 100)
