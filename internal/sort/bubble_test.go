...
func TestBubbleInt_WhenOrderAsc_ShouldOrderAsc(t *testing.T) {
	// Arrange
	...
	// Act
	sortedArr := sort.BubbleInt(unsortedArr, false)
...
func TestBubbleInt_WhenOrderDesc_ShouldOrderDesc(t *testing.T) {
	// Arrange
	unsortedArr := generate.UnsortedIntArray(10, 100)
